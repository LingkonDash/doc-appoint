...
const PrimaryButton = ({
  ...
  const content = (
    ...
    >
      {/* Glow Effect */}
      <span
        className="absolute inset-0 rounded-2xl opacity-0 blur-2xl transition-all duration-500 bg-secondary/30 group-hover:opacity-100"
      />

      {/* Shine Sweep */}
      <span
        className="absolute top-0 left-[-120%] h-full w-[120%] rotate-12 bg-linear-to-r from-transparent via-white/25 to-transparent transition-all duration-500 group-hover:left-[120%]"
      />
